...
from easygram.config.version import AppVersion, current_version
from easygram.domain.updates import ReleaseAsset, ReleaseInfo, UpdateCheckResult
...
class UpdateService:
    ...
    def download_release(self, release: ReleaseInfo, asset: ReleaseAsset) -> DownloadedRelease:
        ...
        releases_dir = Path(tempfile.mkdtemp(prefix="easygram-update-"))
